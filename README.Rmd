...
The goal of `toypackageLH` is to provide convenience functions for some common tasks.

## Installation

You can install the development version of `toypackageLH` from [GitHub](https://github.com/) with:
